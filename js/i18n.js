...
const translations = {
    ...
    en: {
        ...
        timeline: [
            ...
            { year: "2026 — Now", icon: "⚡", title: "Now", text: "Working on my own games and, in parallel, on the NeoAxis game engine." },
        ],

        current_title: "Current Projects",
        current_subtitle: "What I'm working on right now",
        current_badge: "In Development",
        current_progress: "Development progress",
        current_soon: "Screenshots coming soon",

        // ── Карточки текущих проектов.
        //    Порядок должен совпадать с currentProjects[] внизу файла ──
        current_projects: [
            {
                name: "Way to Home",
                desc: "A PSX-style horror with a corridor open world. The player's main goal is to make it home from the store alive and in one piece — which the monsters lurking in the night will do their best to prevent...",
            },
            {
                name: "Albert's Ring",
                desc: "A medieval dynasty roguelike somewhere between Crusader Kings 3 and Yes, Your Grace. You get a randomly generated ruler and have to survive twelve days until the siege without being killed by your own vassals...",
            },
        ],

        // ── Мини-блок: работа над движком ──
        engine_badge: "Contract work",
        engine_title: "NeoAxis Engine",
        engine_desc: "I work on the NeoAxis game engine — porting it to macOS, web and iOS. Every result of my work goes to the engine's creator for review and merge.",
        engine_link: "About the engine →",
    ...
    ru: {
        ...
        timeline: [
            ...
            { year: "2026 — сейчас", icon: "⚡", title: "Сейчас", text: "Работаю над своими играми и параллельно занимаюсь разработкой игрового движка NeoAxis." },
        ],

        current_title: "Текущие проекты",
        current_subtitle: "Над чем я работаю прямо сейчас",
        current_badge: "В разработке",
        current_progress: "Прогресс разработки",
        current_soon: "Скриншоты скоро будут",
        ...
        current_projects: [
            {
                name: "Way to Home",
                desc: "Хоррор в стиле PSX с коридорным открытым миром. Основная задача игрока — пройти путь от магазина до дома живым и невредимым, чему будут активно мешать монстры, прячущиеся в ночи...",
            },
            {
                name: "Albert's Ring",
                desc: "Рогалик о средневековой династии на стыке Crusader Kings 3 и Yes, Your Grace. Игроку достаётся случайно сгенерированный правитель, которому нужно продержаться двенадцать дней до осады и не погибнуть от рук собственных вассалов...",
            },
        ],

        // ── Мини-блок: работа над движком ──
        engine_badge: "Контракт",
        engine_title: "NeoAxis Engine",
        engine_desc: "Работаю над игровым движком NeoAxis — портирую его на macOS, web и iOS. Все результаты работы передаю создателю движка на ревью и мёрдж.",
        engine_link: "О движке →",
    ...
    de: {
        ...
        timeline: [
            ...
            { year: "2026 — Jetzt", icon: "⚡", title: "Jetzt", text: "Arbeite an meinen eigenen Spielen und parallel an der NeoAxis-Spiel-Engine." },
        ],

        current_title: "Aktuelle Projekte",
        current_subtitle: "Woran ich gerade arbeite",
        current_badge: "In Entwicklung",
        current_progress: "Entwicklungsfortschritt",
        current_soon: "Screenshots folgen bald",
        ...
        current_projects: [
            {
                name: "Way to Home",
                desc: "Ein PSX-Stil-Horror mit einer Korridor-Offenen-Welt. Das Hauptziel des Spielers ist es, den Weg vom Laden nach Hause lebend und unverletzt zu überstehen — was die in der Nacht lauernden Monster aktiv verhindern werden...",
            },
            {
                name: "Albert's Ring",
                desc: "Ein mittelalterliches Dynastie-Roguelike zwischen Crusader Kings 3 und Yes, Your Grace. Man erhält einen zufällig generierten Herrscher und muss zwölf Tage bis zur Belagerung überleben, ohne von den eigenen Vasallen getötet zu werden...",
            },
        ],

        // ── Мини-блок: работа над движком ──
        engine_badge: "Auftragsarbeit",
        engine_title: "NeoAxis Engine",
        engine_desc: "Ich arbeite an der NeoAxis-Spiel-Engine — Portierung auf macOS, Web und iOS. Alle Arbeitsergebnisse gehen zur Prüfung und zum Merge an den Entwickler der Engine.",
        engine_link: "Über die Engine →",
    ...
    es: {
        ...
        timeline: [
            ...
            { year: "2026 — Ahora", icon: "⚡", title: "Ahora", text: "Trabajo en mis propios juegos y, en paralelo, en el motor de juegos NeoAxis." },
        ],

        current_title: "Proyectos actuales",
        current_subtitle: "En qué estoy trabajando ahora mismo",
        current_badge: "En desarrollo",
        current_progress: "Progreso de desarrollo",
        current_soon: "Capturas muy pronto",
        ...
        current_projects: [
            {
                name: "Way to Home",
                desc: "Un horror de estilo PSX con un mundo abierto en corredor. El objetivo principal del jugador es llegar sano y salvo desde la tienda hasta casa — algo que los monstruos que acechan en la noche harán todo lo posible por impedir...",
            },
            {
                name: "Albert's Ring",
                desc: "Un roguelike de dinastía medieval a medio camino entre Crusader Kings 3 y Yes, Your Grace. Recibes un gobernante generado aleatoriamente y debes sobrevivir doce días hasta el asedio sin que te maten tus propios vasallos...",
            },
        ],

        // ── Мини-блок: работа над движком ──
        engine_badge: "Trabajo por contrato",
        engine_title: "NeoAxis Engine",
        engine_desc: "Trabajo en el motor de juegos NeoAxis — lo porto a macOS, web e iOS. Todos los resultados se los entrego al creador del motor para su revisión y merge.",
        engine_link: "Sobre el motor →",
    ...
    pl: {
        ...
        timeline: [
            ...
            { year: "2026 — teraz", icon: "⚡", title: "Teraz", text: "Pracuję nad własnymi grami i równolegle nad silnikiem gier NeoAxis." },
        ],

        current_title: "Aktualne projekty",
        current_subtitle: "Nad czym właśnie pracuję",
        current_badge: "W trakcie tworzenia",
        current_progress: "Postęp prac",
        current_soon: "Zrzuty ekranu wkrótce",
        ...
        current_projects: [
            {
                name: "Way to Home",
                desc: "Horror w stylu PSX z korytarzowym otwartym światem. Głównym zadaniem gracza jest dotarcie żywym i zdrowym ze sklepu do domu — czemu aktywnie będą przeszkadzać potwory czające się w nocy...",
            },
            {
                name: "Albert's Ring",
                desc: "Roguelike o średniowiecznej dynastii gdzieś pomiędzy Crusader Kings 3 a Yes, Your Grace. Dostajesz losowo wygenerowanego władcę i musisz przetrwać dwanaście dni do oblężenia, nie ginąc z rąk własnych wasali...",
            },
        ],

        // ── Мини-блок: работа над движком ──
        engine_badge: "Praca kontraktowa",
        engine_title: "NeoAxis Engine",
        engine_desc: "Pracuję nad silnikiem gier NeoAxis — portuję go na macOS, web i iOS. Wszystkie wyniki pracy przekazuję twórcy silnika do przeglądu i merge'a.",
        engine_link: "O silniku →",
...
// ============================================================
// ТЕКУЩИЕ ПРОЕКТЫ — техническая часть: процент, теги, картинка.
// Порядок карточек здесь должен совпадать с current_projects[]
// внутри каждого языка выше.
// ============================================================
const currentProjects = [
    ...
    {
        // Albert's Ring
        progress: 25,          // ← поставь свой реальный процент
        tags: ["Unity", "C#", "LeoEcs", "Roguelike"],
        image: "",          // ← положи гифку в assets/current/ и впиши путь сюда
    },
];

// Ссылка в мини-блоке про движок
const engineLink = "https://www.neoaxis.com/";
